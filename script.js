...
const ordalPass = document.getElementById('ordal-pass');
const btnOrdalLogin = document.getElementById('btn-ordal-login');
const btnOrdalClose = document.getElementById('btn-ordal-close');
